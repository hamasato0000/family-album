...
export function AlbumCard({ albumId, contentCount, createdAt }: AlbumCardProps) {
    return (
        ...
        >
            ...
            <div className="aspect-video bg-gradient-to-br from-primary-100 via-white to-primary-50 flex items-center justify-center">
                <PhotoIcon className="w-16 h-16 text-primary-300 group-hover:scale-110 transition-transform duration-300" />
            </div>
