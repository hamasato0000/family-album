...
export function LogoutIcon({ className = defaultProps.className, strokeWidth = defaultProps.strokeWidth }: IconProps) {
    return (
        <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
                strokeLinecap="round"
...
export function UserIcon({ className = defaultProps.className, strokeWidth = defaultProps.strokeWidth }: IconProps) {
    return (
        <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
                strokeLinecap="round"
...
export function TrashIcon({ className = defaultProps.className, strokeWidth = defaultProps.strokeWidth }: IconProps) {
    return (
        <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
                strokeLinecap="round"
